...
function Header() {
  return (
    // <nav classNameName="flex justify-around  bg-slate-500 h-16 items-center">
    //   <div>
    //     <NavLink to=""><h3 classNameName="font-bold text-2xl">
    //       Frame <span classNameName="text-white">Fantasy</span>
    //     </h3></NavLink>

    //   </div>
    //   <div classNameName="flex items-center gap-16">
    //     <input
    //       type="text"
    //       placeholder="Search"
    //       classNameName="w-64 h-8 px-4 outline outline-gray-200 outline-1 rounded-md shadow-md opacity-65 shadow-blue-500/50"
    //     />
    //     <button classNameName=" bg-blue-500 rounded-md px-4 py-1 text-white ">Sign In</button>
    //   </div>
    // </nav>/
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <NavLink to="">
          <h3 className="font-bold text-2xl text-white">
            Frame <span className="text-gray-400">Fantasy</span>
          </h3>
        </NavLink>
